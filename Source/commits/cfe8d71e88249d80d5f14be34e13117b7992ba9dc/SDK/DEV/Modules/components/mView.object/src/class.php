 ...
 * @updated	July 29, 2015, 13:22 (EEST)
 */
class mView
{
	/**
	...
	public function updatePHPCode($code = "")
	{
		...
		fileManager::create($tempFile, $finalCode);
		...
		// Update File
		return fileManager::put($filePath, $finalCode);
	}
	...
	private function buildHeader($wrapped = FALSE)
	{
		...
		// Get Headers
		$privateHeader = resource::get("/resources/DEV/modules/moduleViewHeader.inc");
	...
	private function getDefaultSourceCode()
	{
		...
		$sourceCode = resource::get("/resources/DEV/modules/moduleViewDefault.inc");
