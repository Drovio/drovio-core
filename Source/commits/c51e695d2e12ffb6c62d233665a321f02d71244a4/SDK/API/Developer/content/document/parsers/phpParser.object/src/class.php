...
importer::import("API", "Developer", "content::document::iParser");

use \API\Developer\content\document\iParser;
 ...
 * @revised	November 3, 2013, 18:34 (EET)
 */
class phpParser implements iParser
{
	...
	/**
	 * Clears the code from invalid characters.
	 * It also uses the html_entity_decode().
	 * 
	 * @param	string	$code
	 * 		The code to be cleared.
	 * 
	 * @return	string
	 * 		The cleared php code.
	 */
