...
FormProtocol = {
	...
	submit : function(ev, jqForm) {
		...
		if (jqForm.data("form-action") != undefined) {
			...
			ModuleProtocol.trigger(ev, jqForm, "POST", "formAction", formInputs, successCallback, null, completeCallback, true);
		} else {
			// Set ascop attributes
			ajaxOptions = new Object();
			ajaxOptions.loading = true;
			...
			ascop.request(formAction, "POST", formInputs, jqForm, successCallback, ajaxOptions);
		}
	},
