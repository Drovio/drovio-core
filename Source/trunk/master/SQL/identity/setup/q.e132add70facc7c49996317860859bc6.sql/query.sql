...
CREATE TABLE IF NOT EXISTS `ID_account` (
	...
	`username` varchar(200) COLLATE utf8_general_ci DEFAULT NULL,
...
ALTER TABLE `ID_personToAccount`
	...
	ADD CONSTRAINT `ID_personToAccount_ibfk_1` FOREIGN KEY (`person_id`) REFERENCES `ID_person` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
