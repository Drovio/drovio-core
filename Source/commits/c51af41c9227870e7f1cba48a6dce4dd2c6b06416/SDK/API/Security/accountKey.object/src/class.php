 ...
 * @revised	August 12, 2014, 16:52 (EEST)
 */
class accountKey
{
	/**
	...
	public static function create($userGroup_id, $type, $context)
	{
		...
		$attr['time'] = time();
		$attr['akey'] = self::key(account::getAccountID()."_".$type, $context);
		return $dbc->execute($q, $attr);
	}
	
	/**
	 * Get all account access keys.
	 * 
	 * @return	array
	...
	public static function get()
	{
		// Set Database Connection
		$dbc = new dbConnection();
		$q = new dbQuery("29518071788493", "profile.account");
