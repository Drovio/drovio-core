...
class literalManager
{
	 ...
	 * This will remove all literals that are children of this scope.
	 * 
	 * @param	integer	$projectID
	 * 		The scope's project id.
	 * 
	 ...
	 * 		True on success, false on failure.
	 */
	protected static function removeValue($projectID, $scope, $name, $locale)
	{
		// Get dbQuery
		$dbc = new dbConnection();
		$dbq = new dbQuery("25554386525779", "literals");
