...
class dbConnection
{
	...
	public function execute($query)
	{
		...
		{
			// Log activity
			loggr::log("Executing SQL Query to ".$this->host, loggr::INFO, $query, loggr::DATABASE_IO);
		...
		catch (Exception $ex)
		{
			...
			loggr::log("Query Execution failed. Message error: ".$ex->getMessage(), loggr::ERROR);
	...
	{
		// Log
		loggr::log("Escaping Database Resource.", loggr::INFO, $resource, loggr::DATABASE_IO);
