...
class commitManager extends windowFrame
{
	...
	private function buildCommitSection()
	{
		...
		if (count($workingItems) == 0)
		{
			...
			$noItemsDesc = DOM::create("h3", $desc, "", "hd center");
		...
		// Commit Tags
		$commitTags = $form->getInput($type = "text", $name = "tags", $value = "", $class = "uiCommitSummText", $autofocus = FALSE, $required = FALSE);
