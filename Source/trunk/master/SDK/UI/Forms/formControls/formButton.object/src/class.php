 ...
 * 
 * @version	0.1-5
 * @created	March 11, 2013, 14:20 (CET)
 * @updated	November 12, 2016, 16:17 (CET)
 * 
...
class formButton extends formItem
{
	 ...
	 * 
	 * @param	string	$name
	 * 		The button's name (it is used only when forms post normal - not async with ajax).
	 * 
	 * @param	boolean	$positive
	 * 		Indicates a positive submit button.
	 * 		It is used for 'submit', 'ok', 'yes' and in general any positive answer to a form.
	 * 
	 * @return	formButton
	...
	public function build($title = "Submit", $type = "submit", $id = "", $name = "", $positive = FALSE)
	{
		...
		// Build Input
		parent::build("button", $name, $id, "", "uiFormButton".($positive ? " positive" : ""), $title);
