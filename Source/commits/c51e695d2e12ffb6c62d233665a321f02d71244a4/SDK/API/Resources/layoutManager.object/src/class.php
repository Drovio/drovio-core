 ...
 * @revised	April 29, 2013, 11:50 (EEST)
 */
class layoutManager
{
	/**
	 * Holds the path that css files will be exported on release procedeure.
	 * 
	 * @type	string
	 */
	const CSS_EXPORT_PATH = '/System/Library/CSS/Misc'; 
	...
	{
		$hashName = hash("md5", 'redback.'.'system'.'.layoutstyles');
		return "lt.".$hashName;
	}
