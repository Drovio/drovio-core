 ...
 * @updated	February 17, 2015, 12:39 (EET)
 */
class loginDialog extends UIObjectPrototype
{
	...
	public function build($username = "", $logintype = self::LGN_TYPE_PAGE)
	{
		...
		// Build main body
		$this->buildMainForm($username, $logintype, $return_sub, $return_path);
	 ...
	 * @return	void
	 */
	private function buildMainForm($usernameValue = "", $logintype = self::LGN_TYPE_PAGE)
	{
		// Main Container
