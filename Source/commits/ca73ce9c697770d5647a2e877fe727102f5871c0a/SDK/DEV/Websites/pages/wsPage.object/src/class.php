 ...
 * @revised	September 26, 2014, 17:36 (EEST)
 */
class wsPage
{
	/**
	...
	{
		$path = systemRoot.paths::getDevRsrcPath()."/headers/website/page.inc";
	...
	private function getDefaultSourceCode()
	{
		...
		$sourceCode = fileManager::get(systemRoot.paths::getDevRsrcPath()."/templates/wsPageDefault.inc");
	...
	{
		// Create object index
		$status = FALSE;//$this->website->removeObjectIndex("pages", "page", $this->name);
	 ...
	 * 		True on success, false on failure.
	 */
	public function updateInfo($sdk_dependencies = array(), $ws_dependencies = array())
	{
		// Load view folder
		$itemID = $this->getItemID();
