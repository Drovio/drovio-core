...
$pageCSS = $page->getCSS($normalCss = TRUE);
...
// Set Variables
$pageCSS = str_replace("%resources%", $resourceUrl, $pageCSS);
$pageCSS = str_replace("%{resources}", $resourceUrl, $pageCSS);
$pageCSS = str_replace("%media%", $resourceUrl, $pageCSS);
$pageCSS = str_replace("%{media}", $resourceUrl, $pageCSS);

// Resolve all urls
$pageCSS = BootLoader::resolveURLs(NULL, $pageCSS, NULL, $protocol = NULL, "");
