...
importer::import("DEV", "Websites", "source/srcObject");
 ...
 * @updated	May 29, 2015, 12:51 (EEST)
 */
class srcPackage
{
	/**
	...
	public function loadCSS($library, $package)
	{
		...
		{
			$webObj = new srcObject($websiteID, $library, $package, $object['namespace'], $object['name']);
