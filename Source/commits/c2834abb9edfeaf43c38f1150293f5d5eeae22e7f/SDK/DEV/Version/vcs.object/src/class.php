 ...
 * @revised	September 17, 2014, 12:29 (EEST)
 */
class vcs
{
	/**
	 ...
	 * 
	 * @return	string
	 * 		The item's working branch path.
	 */
	public function getItemBranchPath($id)
	{
		...
		// Return item's trunk path
		return $this->repository.self::BRANCHES_FOLDER.$workingBranch."/".$this->getItemPath($id, $workingBranch);
	}
	...
	public function getItemHeadPath($id)
	{
		...
		// Return item's trunk path
		return $this->repository.self::BRANCHES_FOLDER.$headBranch."/".$this->getItemPath($id, $headBranch);
	}
