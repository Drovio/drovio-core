 ...
 * @revised	August 22, 2014, 13:18 (EEST)
 */
class mView
{
	/**
	...
	private function getDefaultSourceCode()
	{
		...
		$sourceCode = fileManager::get(systemRoot.paths::getDevRsrcPath()."/templates/moduleViewDefault.inc");
	...
	private function buildHeader($wrapped = FALSE)
	{
		...
		// Get Headers
		$path = systemRoot.paths::getDevRsrcPath()."/headers/moduleView.inc";
