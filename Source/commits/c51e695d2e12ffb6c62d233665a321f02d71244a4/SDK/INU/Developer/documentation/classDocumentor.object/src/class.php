...
// Temporay For Compability reasons
 ...
 * @revised	October 9, 2013, 11:42 (EEST)
 */
...
{	
	...
	public function build($manual = "", $name = "docuContent")
	{
		...
		// Refresh temp button
		$documentTool = DOM::create("div", "Generate", "", "docuTool");
		...
		*/
		// Expander model
		/*$classExpander = new expander();
		DOM::append($docContainer, $classExpander->get());
		*/
		// Class model
