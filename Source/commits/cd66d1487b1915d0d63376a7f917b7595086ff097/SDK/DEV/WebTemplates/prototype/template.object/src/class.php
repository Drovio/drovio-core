 ...
 * 
 * @version	2.0-1
 * @created	September 16, 2015, 12:36 (EEST)
...
class template
{
	 ...
	 * 		Indicates whether the index file path is root relative or not.
	 * 		It is FALSE by default.
	 * 
	 * @return	void
	 */
	public function __construct($indexFilePath, $rootRelative = FALSE)
	{
		// Create index map file (if first time)
		$this->indexFilePath = ($rootRelative ? systemRoot : "").$indexFilePath;
		$this->createMapFile();
	}
	 ...
	 */
	protected function createMapFile()
	{
