 ...
 * @updated	November 14, 2015, 21:27 (GMT)
 */
class account extends IDAccount
{
	...
	public function setCookies($authToken, $rememberme = FALSE)
	{
		...
		cookies::set("auth_token", $this->authToken, $duration, TRUE);
	}
	...
	public function getAuthToken()
	{
		...
		$authToken = engine::getVar("auth_token");
		$authToken = (empty($authToken) ? engine::getVar("__DRVID_AST") : $authToken);
