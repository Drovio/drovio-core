 ...
 * @updated	March 5, 2015, 17:13 (EET)
 */
class sdkLibrary
{
	/**
			...
			foreach ($packages as $packageName)
			{
				...
				foreach ($objects as $objectInfo)
				{
					...
					foreach ($locales as $localeInfo)
					{
						...
						if (empty($manContent))
							continue;
						$manFile = systemRoot."/System/Resources/Documentation/SDK/".$libName."/".$packageName."/".$ns."/".$objectInfo['name'].".manual.".$locale.".html";
						fileManager::create($manFile, $manContent, TRUE);
					}
					// Remove old manual file
					fileManager::remove(systemRoot."/System/Resources/Documentation/SDK/".$libName."/".$packageName."/".$ns."/".$objectInfo['name'].".manual.html");
				...
				$cssContent = BootLoader::resolveURLs(coreProject::PROJECT_ID, $cssContent, $version, $protocol = "https", $innerFolder);
