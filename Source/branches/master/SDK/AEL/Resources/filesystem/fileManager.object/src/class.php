 ...
 * @updated	October 3, 2015, 17:53 (EEST)
 */
class fileManager
{
	/**
	...
	/**
	 * Get a public url pointing at the given file path.
	 * 
	 * @param	string	$file
	 * 		The file path.
	 * 
	...
	public function getPublicUrl($file)
	{
		...
		// Create public url
		$urlFile = str_replace(systemRoot.paths::getProfilePath(), "", $rootFolder."/".$file);
		return url::resolve("profile", $urlFile);
	}
	 ...
	 */
	public static function getUrl($url, $context = NULL)
	{
