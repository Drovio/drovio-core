 ...
 * @revised	September 29, 2014, 14:36 (EEST)
 */
class application extends project
{
	...
	/**
	 * Gets all application views, in all folders.
	 * 
	 * @return	array
	...
	public function publish($version, $branchName = vcs::MASTER_BRANCH)
	{
		...
		// Publish Views
		$allViews = $this->getAllViews($releaseFolder);
	 ...
	 * 		[folderName] => viewName
	 */
	private function getAllViews($releaseFolder)
	{
		$parser = new DOMParser();
