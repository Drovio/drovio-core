 ...
 * @revised	November 5, 2014, 15:52 (EET)
 */
class HTTPRequest
{
	/**
	 * An array containing all the url variables (name and value).
	 * 
	 * @type	array
	 */
	private static $urlvars;
	 ...
	 * 		The cookie name.
	 * 		If this is set, the function will search for the cookie variable if not found in the url variables.
