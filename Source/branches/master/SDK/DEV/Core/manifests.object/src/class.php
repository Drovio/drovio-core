...
class manifests
{
	...
	public function create($name, $packages = array())
	{
		...
		// Set plans
		$this->setPlans($mfID, $premium = FALSE, $enterprise = FALSE);
	 ...
	 * 		Enterprise plan permission.
	 * 		Default value is FALSE.
	 * 
	 * @return	boolean
	 * 		True on success, false on failure.
	 */
	public function setPlans($mfID, $premium = FALSE, $enterprise = FALSE)
	{
		// Initialize parser
		$parser = $this->xmlParser;
		...
		$parser->attr($manifest, "enterprise", ($enterprise ? 1 : NULL));
