 ...
 * @updated	May 10, 2015, 12:21 (EEST)
 */
class sdkPackage
{
	/**
	...
	/**
	 * Loads the entire package's css style code into the output buffer.
	 * 
	 * @param	string	$library
	 * 		The library name.
	 * 
	...
	public function loadCSS($library, $package)
	{
		...
		foreach ($objects as $object)
		{
			...
			$packageCSS .= $sdkObj->getCSSCode($normalCSS = TRUE)."\n";
		}
	...
	/**
	 * Loads the entire package's javascript code into the output buffer.
	 * 
	 * @param	string	$library
	 * 		The library name.
	 * 
