...
importer::import("GTL", "Docs", "pdf/TTFontFile");

use \API\Model\core\resource;
use \GTL\Docs\pdf\TTFontFile;

/**
 * PDF Generator with php
 * 
 * This class is a modified version of FPDF that adds UTF-8 support.
 * Moreover, it embeds only the necessary parts of the fonts that are used in the document, making the file size much smaller than if the whole fonts were embedded.
 * 
 * @version	1.0-2
 * @created	September 27, 2015, 23:09 (EEST)
 * @updated	September 27, 2015, 23:35 (EEST)
 * @throws	Exception
 */
class tFPDF
{
	...
	public function __construct($orientation='P', $unit='mm', $size='A4')
	{
		...
		elseif(is_dir(dirname(__FILE__).'/font'))
			...
			$this->fontpath = resource::getPath("/resources/fonts/", $rootRelative = FALSE);
		// Core fonts
	...
	{
		$this->_out('/Producer '.$this->_textstring('tFPDF '.self::VERSION));
		if(!empty($this->title))
