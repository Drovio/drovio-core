 ...
 * @updated	February 17, 2015, 11:27 (EET)
 */
class sdkLibrary
{
	/**
	...
	public static function publish($version, $branchName = vcs::MASTER_BRANCH)
	{
		...
		foreach ($libraries as $libName)
		{
			...
			foreach ($packages as $packageName)
			{
				...
				BootLoader2::exportCSS(coreProject::PROJECT_ID, $libName, $packageName, $cssContent, $version);
				...
				BootLoader2::exportJS(coreProject::PROJECT_ID, $libName, $packageName, $jsContent, $version);
			}
		}
	}
