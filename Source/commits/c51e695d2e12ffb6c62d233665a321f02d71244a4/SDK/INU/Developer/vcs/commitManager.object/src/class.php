 ...
 * VCS Commit Manager
 * 
 * Displayes all the authors items that must be commited.
 * 
 * @version	{empty}
 * @created	November 21, 2013, 20:03 (EET)
 * @revised	November 21, 2013, 20:03 (EET)
 */
class commitManager extends UIObjectPrototype
{
	...
	private function buildBody()
	{
		...
		// Build Title
		$title = DOM::create("h2", "Version Control Commit Manager");
