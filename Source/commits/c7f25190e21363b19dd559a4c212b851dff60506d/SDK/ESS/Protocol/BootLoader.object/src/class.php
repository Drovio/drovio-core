 ...
 * @updated	February 19, 2015, 15:51 (EET)
 */
class BootLoader
{
	/**
	 ...
	 * 		The inner folder of the resources for the project-relative urls.
	 * 
	 * @return	string
	 * 		The content with resolved urls.
	 */
	public static function resolveURLs($projectID, $content, $version, $protocol = NULL, $innerFolder = "")
	{
		...
		$cdnUrl = str_replace($protocol.":", "", $cdnUrl);
