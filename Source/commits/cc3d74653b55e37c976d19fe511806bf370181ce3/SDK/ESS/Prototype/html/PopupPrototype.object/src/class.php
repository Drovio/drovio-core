 ...
 * @revised	September 11, 2013, 17:46 (EEST)
 */
class PopupPrototype extends UIObjectPrototype
{
	 ...
	 * Finaly, if only the position is set as an array, this is used to position the popup in relation with the window ['fixed'] or the parent ['absolute']. That array can have the following keys: top, bottom, left, right, position.
	 * 
