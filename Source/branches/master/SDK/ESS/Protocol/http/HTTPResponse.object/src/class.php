 ...
 * 
 * Manages and adapts the http response according to Drovio rules.
 * 
 * @version	2.0-2
 * @created	November 5, 2014, 13:30 (GMT)
 * @updated	November 25, 2015, 19:57 (GMT)
 */
class HTTPResponse
{
	/**
	...
	/**
	 * Initializes the response headers with the Drovio ones.
	 * 
	...
	/**
	 * Set the header response status code.
	 * 
	 * @param	integer	$code
	 * 		A valid response status code.
	 * 
	 * @return	void
	 */
	...
	/**
	 * Sets some headers for the Drovio response identity.
	 * 
	 * @return	void
	 */
	private static function setIdentity()
	{
		...
		// Powered By
		header('X-Powered-By: Drovio Services Protocol');
		
		// P3P Policy
		header('P3P:CP="Drovio does not have a P3P policy."');
	}
}
//#section_end#
?>