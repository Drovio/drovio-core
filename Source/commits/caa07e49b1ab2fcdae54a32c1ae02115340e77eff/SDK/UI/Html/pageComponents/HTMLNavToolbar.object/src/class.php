 ...
 * @revised	January 3, 2014, 10:22 (EET)
 */
class HTMLNavToolbar extends UIObjectPrototype
{
	...
	/**
	 * Gets the toolbar clear action array.
	 * 
	 * @return	array
	 * 		An array containing the action "type" and the action "value".
	 */
	...
	private function buildProfileTools()
	{
		...
		if (privileges::accountToGroup("RB_DEVELOPER") && empty($subDomain))
		{
	...
	{		
		...
		foreach ($groups as $group)
		{
			...
			HTMLRibbon::addNavigation($item, $colID, $colRibbon, $colType);
		}
	}
