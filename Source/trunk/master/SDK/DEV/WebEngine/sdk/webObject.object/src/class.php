...
importer::import("DEV", "WebEngine", "sdk/webObjectManual");
...
use \DEV\WebEngine\sdk\webObjectManual;
 ...
 * 
 * @version	1.0-2
 * @created	April 4, 2014, 9:44 (BST)
 * @updated	December 6, 2015, 16:09 (GMT)
 */
class webObject extends classObject
{
	...
	{
		// Initialize new vcs
		$this->vcs = new vcs(webCoreProject::PROJECT_ID);
	...
	{  
		$path = systemRoot.paths::getDevRsrcPath()."/webEngine/headers/sdkObject.inc";
	...
	public function getManual($locale = NULL)
	{
		...
		$manDoc = new webObjectManual($itemFolder, "", "manual");
