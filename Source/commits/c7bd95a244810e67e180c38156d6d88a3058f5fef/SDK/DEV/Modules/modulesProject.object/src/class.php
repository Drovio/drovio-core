 ...
 * @updated	January 20, 2015, 15:42 (EET)
 */
class modulesProject extends project
{
	...
	private function publishSource($version, $branchName = vcs::MASTER_BRANCH)
	{
		...
		while ($row = $dbc->fetch($result))
		{
			...
			BootLoader2::exportCSS(self::PROJECT_ID, "Modules", $moduleID, $moduleCSS, $version);
			...
			BootLoader2::exportJS(self::PROJECT_ID, "Modules", $moduleID, $moduleJS, $version);
