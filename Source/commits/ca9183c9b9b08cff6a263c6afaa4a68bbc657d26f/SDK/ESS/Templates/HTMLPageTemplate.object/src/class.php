 ...
 * @updated	February 24, 2015, 14:39 (EET)
 */
...
{	
	...
	private function setHead($meta = FALSE, $og = FALSE)
	{
		...
		$this->addMeta($name = "generator", $content = "Redback Platform", $httpEquiv = "", $charset = "");
		
		// Redback Icon
		$faviconUrl = url::resolve("cdn", "/media/logos/x150/logo_150.png");
