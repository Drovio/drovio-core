INSERT INTO `users`(`user_id`, `joindate`, `intial_platform`, `initial_device_type`, `initial_country`, `initial_region`, `initial_city`, `platform`, `intial_referrer`, `initial_browser`, `intial_landing_page`, `initial_device`, `initial_carrier`) VALUES (
