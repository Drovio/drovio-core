 ...
 * 
 * @version	0.1-3
 * @created	September 17, 2015, 17:56 (BST)
 * @updated	December 11, 2015, 12:58 (GMT)
 */
class templateThemeCSSPrototype
{
	 ...
	 * @return	void
	 */
	public function __construct($indexFilePath, $themeIndexFilePath, $cssFolderPath = "")
	{
		// Initialize
		$this->templateTheme = new templateThemePrototype($indexFilePath, $themeIndexFilePath);
