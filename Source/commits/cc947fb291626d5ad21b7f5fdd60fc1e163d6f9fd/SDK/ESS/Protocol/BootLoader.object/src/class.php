 ...
 * @revised	September 1, 2014, 15:28 (EEST)
 */
class BootLoader
{
	/**
	...
	/**
	 * The module being loaded at this call.
	 * 
	 * @type	integer
	 */
	...
	/**
	 * Sets the module id being loaded.
	 * 
	 * @param	integer	$moduleID
	 * 		The module id being loaded.
	 * 
	 * @return	void
	 */
	 ...
	 * 
	 * @return	array
	 * 		The module resource for the BootLoader.
	 * 
	...
	public static function getModuleResource()
	{
		...
		$attr['id'] = self::getRsrcID("Modules", self::$moduleID);
	...
	private static function getModuleRsrcArray($moduleID)
	{
		...
		// Set unique resource id
		$resource['id'] = self::getRsrcID("Modules", $moduleID);
