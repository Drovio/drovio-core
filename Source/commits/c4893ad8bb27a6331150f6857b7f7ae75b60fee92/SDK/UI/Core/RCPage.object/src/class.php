 ...
 * @updated	February 13, 2015, 12:50 (EET)
 */
class RCPage extends HTMLPageTemplate
{
	...
	private function addResources()
	{
		...
		{
			$jsResourceUrl = BootLoader::getResourceUrl(BootLoader::RSRC_JS, coreProject::PROJECT_ID, "jQuery", $rsrcName);
			$resource = $this->addScript($jsResourceUrl);
			$rsrcID = BootLoader::getRsrcID("jQuery", $rsrcName);
