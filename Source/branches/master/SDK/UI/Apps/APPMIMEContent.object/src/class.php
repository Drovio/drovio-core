 ...
 * @updated	September 15, 2015, 17:37 (EEST)
 */
class APPMIMEContent extends MIMEContent
{
	 ...
	 * 		Whether to use the shared folder location or not.
	 * 		It is FALSE by default.
	 * 
	 * @return	APPMIMEContent
	 * 		The APPMIMEContent object.
	 */
	public function set($fileName, $type = self::CONTENT_APP_STREAM, $mode = self::ACCOUNT_MODE, $shared = FALSE)
	{
		// Get file contents
		$fm = new AppFileManager($mode, $shared);
