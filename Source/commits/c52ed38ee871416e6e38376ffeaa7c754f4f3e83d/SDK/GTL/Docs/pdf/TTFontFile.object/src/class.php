 ...
 * 
 * Parses a ttf font file and generates  helper files for the tFPDF unicode.
 * 
 * @version	0.1-2
 * @created	September 27, 2015, 23:41 (EEST)
 * @updated	September 27, 2015, 23:59 (EEST)
 */
class TTFontFile
{
	/**
	 ...
	 * {description}
	 * 
	 * @param	{type}	$numberOfHMetrics
	 * 		{description}
	 * 
	 * @param	{type}	$numGlyphs
	 * 		{description}
	 * 
	 * @param	{type}	$glyphToChar
	 * 		{description}
	 * 
	 * @param	{type}	$scale
	 * 		{description}
	 ...
	 * {description}
	 * 
	 * @param	{type}	$unicode_cmap_offset
	 * 		{description}
	 * 
	 * @param	{type}	$glyphToChar
	 * 		{description}
	 * 
	 * @param	{type}	$charToGlyph
	 * 		{description}
	 * 
	 * @return	void
	 */
