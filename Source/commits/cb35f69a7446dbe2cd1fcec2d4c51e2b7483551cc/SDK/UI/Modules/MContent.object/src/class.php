 ...
 * @revised	September 18, 2014, 17:21 (EEST)
 */
class MContent extends HTMLContent
{
	 ...
	 */
	public static function getModuleContainer($moduleID, $viewName = "", $attr = array(), $startup = TRUE, $containerID = "", $loading = FALSE)
	{
		$moduleContainer = new ModuleContainerPrototype($moduleID, $viewName);
		return $moduleContainer->build($attr, $startup, $containerID, $loading)->get();
	}
