...
class accountKey extends apiKey
{
	...
	public static function validate($akey, $context, $type)
	{
		...
		// Validate key
		return parent::validateKey($akey, $accountID = NULL, $teamID, $projectID);
	}
	...
	public static function validateAccount($akey, $context, $type)
	{
		...
		// Validate
		return ($keyInfo['account_id'] == account::getAccountID() && ($keyInfo['team_id'] == $teamID || $keyInfo['project_id'] == $projectID));
	}
	...
	public static function validateGroup($groupName, $context, $type)
	{
		...
		// Validate group
		return parent::validateGroupName($groupName, account::getAccountID(), $teamID, $projectID);
	}
	...
	public static function validateGroupID($groupID, $context, $type)
	{
		...
		// Validate group
		return parent::validateGroup($groupID, account::getAccountID(), $teamID, $projectID);
	}
