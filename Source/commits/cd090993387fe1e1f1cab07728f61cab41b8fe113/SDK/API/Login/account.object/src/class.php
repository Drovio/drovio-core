 ...
 * @updated	November 14, 2015, 19:39 (GMT)
 */
class account extends IDAccount
{
	...
	public function setCookies($authToken, $rememberme = FALSE)
	{
		...
		cookies::set("__DRVID_AST", $this->authToken, $duration, TRUE);
	}
	...
	public function getAuthToken()
	{
		...
		$authToken = engine::getVar("__DRVID_AST");
		$authToken = (empty($authToken) ? engine::getVar("ast") : $authToken);
