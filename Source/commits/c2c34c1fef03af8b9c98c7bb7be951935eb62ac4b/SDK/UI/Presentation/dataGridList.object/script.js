...
dataGridList = {
	...
	addRow: function(gridList, contents) {
		...
		jqGridList.find(".dataGridContentWrapper").prepend(row);
	...
	filter: function(gridList, search) {
		// Get jQuery object (if not)
		var jqGridList = jq(gridList);
		
		// If search is empty, show all rows
		if (search == "")
			return jqGridList.find(".dataGridRow").show();
		...
		jqGridList.find(".dataGridRow").hide().filter(function() {
