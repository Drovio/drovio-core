 ...
 * @revised	November 3, 2014, 9:54 (EET)
 */
class companyProduct extends globalProduct
{
	 ...
	 * @return	void
	 */
	public function create($productCode, $productCodeType, $productHierarchy, $title, $description = "")
	{
		// Init global product by product code
		if (!$this->initWithCode($productCodeType, $productCode))
		{
			// Create global product
			$status = parent::create($title, $description);
			if (!$status)
				return FALSE;
