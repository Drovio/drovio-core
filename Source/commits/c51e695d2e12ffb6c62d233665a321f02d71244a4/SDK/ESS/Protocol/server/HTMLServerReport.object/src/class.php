 ...
 * @revised	April 9, 2013, 15:44 (EEST)
 */
class HTMLServerReport extends ServerReport
{
	 ...
	 * @return	ServerReport
	 */
	public static function addContent($content, $type = "data", $holder = "", $method = "replace")
	{
	 ...
	 * @return	DOMElement
	 */
	protected static function getReportContent($type = "data", $context = NULL, $holder = NULL, $method = "replace")
	{
