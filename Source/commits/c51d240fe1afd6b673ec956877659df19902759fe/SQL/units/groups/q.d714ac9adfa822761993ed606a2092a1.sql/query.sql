SELECT moduleGroup.id, moduleGroup.description, 
...
LEFT OUTER JOIN UNIT_moduleGroup AS moduleParent ON moduleGroup.parent_id = moduleParent.id 
WHERE moduleGroup.id = 17