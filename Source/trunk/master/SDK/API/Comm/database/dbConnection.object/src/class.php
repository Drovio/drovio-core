 ...
 * @updated	November 13, 2015, 20:11 (GMT)
 */
class dbConnection
{
	/**
	...
	/**
	 * Magic implemented class for var_dump.
	 * This is supported for PHP >= 5.6.0
	 * 
	 * @return	array
	 * 		An array with debug information about this class.
	 */
	public function __debugInfo()
	{
		...
		$debugInfo = array();
		$debugInfo['debug_info_disclaimer'] = "This class is not available for debug info.";
