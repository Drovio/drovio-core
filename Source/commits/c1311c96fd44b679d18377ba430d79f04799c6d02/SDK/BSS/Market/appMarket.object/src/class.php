 ...
 * @updated	August 25, 2015, 14:14 (EEST)
 */
class appMarket
{
	/**
	...
	public static function getTeamApplications()
	{
		...
		$dbc = new dbConnection();
		$dbq = new dbQuery("34095792746165", "boss.library");
	...
	public static function getBossApplications($start = 0, $count = 30)
	{
		// Get all boss apps
		$dbc = new dbConnection();
		$dbq = new dbQuery("15623717209617", "boss.library");
	...
	public static function getTeamPrivateApplications($start = 0, $count = 30)
	{
		...
		$dbc = new dbConnection();
		$dbq = new dbQuery("31857889724926", "boss.library");
