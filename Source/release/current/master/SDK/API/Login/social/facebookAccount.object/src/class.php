 ...
 * @updated	November 14, 2015, 20:24 (GMT)
 */
class facebookAccount extends IDFacebookAccount
{
	...
	public function login($code)
	{
		...
		$info = array();
		$info['client_id'] = "1528296957491399";
		$info['client_secret'] = "e7d5acbd7810e3ffe3898c9cb3e2e7c8";
		$info['redirect_uri'] = url::resolve("www", "/ajax/account/oauth/facebook.php");
