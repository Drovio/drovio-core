 ...
 * @updated	May 19, 2015, 15:06 (EEST)
 */
class Form extends FormPrototype
{
	 ...
	 */
	public static function getSubmitContent($content, $fullReset = FALSE)
	{
		...
		HTMLServerReport::addContent($content, $type = HTMLServerReport::CONTENT_HTML, $holder = ".formReport", $method = HTMLServerReport::REPLACE_METHOD);
