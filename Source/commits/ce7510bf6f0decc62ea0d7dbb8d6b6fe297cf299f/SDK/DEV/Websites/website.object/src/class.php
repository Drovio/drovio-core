 ...
 * @revised	January 2, 2015, 13:35 (EET)
 */
class website extends project
{
	...
	public function publish($version, $branchName = vcs::MASTER_BRANCH, $innerSitePath = "")
	{
		...
		fileManager::copy($releaseFolder."/".self::SETTINGS_FOLDER."/settings.xml", systemRoot.$publishFolder."/.website/settings/settings.xml");
		fileManager::copy($releaseFolder."/".self::SETTINGS_FOLDER."/meta_settings.xml", systemRoot.$publishFolder."/.website/settings/meta_settings.xml");
		...
		// Get robots file
		$robots = fileManager::get($releaseFolder."/robots.txt");
