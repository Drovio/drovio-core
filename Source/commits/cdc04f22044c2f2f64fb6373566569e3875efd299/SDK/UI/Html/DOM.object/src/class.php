 ...
 * @revised	January 28, 2014, 15:52 (EET)
 */
class DOM extends DOMPrototype
{
	...
	/**
	 * Gets or sets a set of attributes of the given element.
	 * 
	 * @param	DOMElement	$elem
	 * 		The element to get or set the attributes.
	 * 
	 * @param	array	$val
	 * 		The attribute array by name and value.
	 * 		If empty, return the element's attribute values.
	 * 
	 * @return	mixed
	 * 		The new element if set new attributes or an array of attribute values by name.
	 */
