...
WHERE VCS_projectWorkingItem.project_id = VCS_projectWorkingItemAuthor.project_id AND VCS_projectWorkingItem.project_id = {pid} AND VCS_projectWorkingItem.branch_name = '{branch}' AND VCS_projectWorkingItemAuthor.author_id = {author}
