 ...
 * @updated	January 21, 2015, 10:35 (EET)
 */
class classComments
{
	/**
	 ...
	 */
	public static function pretifySourceCode($sourceCode, $manual, $library, $package, $namespace, $copyright = "Redback")
	{
	 ...
	 * 		The comment block
	 */
	private function getClassStampComments($library, $package, $namespace, $copyright = "Redback")
	{
		// Normalize attributes
		$library = trim($library);
		$package = trim($package);
		$namespace = trim($namespace);
		$copyright = (empty($copyright) ? "Redback" : $copyright);
		
		// Create Template
		$classStamp = array();
		$classStamp['library'] = (empty($library) ? "{library}" : $library);
