...
PopupProtocol = {
	...
	loadPopup : function(ev, jqThis) {
		// Call Popup
		ModuleProtocol.triggerAction(ev, jqThis, "GET", "pp", "", function(report) {
			PopupProtocol.showPopup(ev, jqThis, report);
		});
	},
	showPopup : function(ev, jqThis, report) {
		// Show popup
		jqThis.popup(report.body[0].context);
