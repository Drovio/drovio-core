...
importer::import("UI", "Prototype", "HTMLPagePrototype");
...
use \UI\Prototype\HTMLPagePrototype;
...
/**
 * Drovio HTML Page Template
 * 
 * This is the base template for all pages.
 * 
 * @version	0.1-1
 * @created	July 28, 2015, 11:40 (EEST)
 * @updated	July 28, 2015, 11:40 (EEST)
 */
class HTMLPageTemplate extends HTMLPagePrototype
{	
	/**
	 * Builds the base template with all the necessary head tags.
	 * It doesn't include building anything about user interface.
	 * 
	 * @param	string	$title
