...
importer::import("API", "Login", "social/facebookAccount");
importer::import("API", "Profile", "team");
importer::import("UI", "Content", "HTMLContent");
importer::import("UI", "Html", "DOM");

use \ESS\Environment\url;
use \API\Login\social\facebookAccount;
use \API\Profile\team;
...
// Get facebook code
$facebookCode = engine::getVar("code");
$status = facebookAccount::getInstance()->login($facebookCode);
if ($status)
{
