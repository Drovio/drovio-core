 ...
 * @revised	January 23, 2014, 0:01 (EET)
 */
class HTML extends DOM
{
	...
	/**
	 * Gets a css selector as string and converts it to xpath.
	 * 
	 * @param	string	$css
	 * 		The css selector to convert to xpath. Does not support pseudo-* and only supports simple equality attribute-wise. Can hold multiple selectors separated with comma.
	 * 
	 * @return	string
	 * 		Returns a string that holds the resulting xpath.
	 */
