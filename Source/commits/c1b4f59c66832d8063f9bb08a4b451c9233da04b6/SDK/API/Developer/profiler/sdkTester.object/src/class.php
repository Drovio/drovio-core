 ...
 * @revised	December 20, 2013, 23:25 (EET)
 */
class sdkTester extends tester
{
	 ...
	 * 		An array of all packages with the mixed package name.
	 * 
	 * @return	boolean
	 * 		True on success, false on failure.
	 */
	public static function activate($packages = array())
	{
		if (empty($packages))
			return self::deactivate("sdkTester");
