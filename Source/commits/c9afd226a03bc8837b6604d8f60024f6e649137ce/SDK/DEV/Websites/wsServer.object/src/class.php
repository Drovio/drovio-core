 ...
 * @revised	October 23, 2014, 20:40 (EEST)
 */
class wsServer
{
	/**
	...
	public function __construct($id)
	{
		...
		if (file_exists($this->settingsFile))
		{
			...
			$this->xmlParser->load($this->settingsFile, FALSE);
		}
	}
	...
	public function create()
	{
		...
		$itemID = $this->getItemID();
		$itemPath = "/";
		$itemName = "servers".".xml";
		$filePath = $this->vcs->createItem($itemID, $itemPath, $itemName, $isFolder = FALSE);
		...
		// Save file
		return $this->xmlParser->save($filePath, "", TRUE);
	}
