...
jq(document).one("ready", function() {
	...
	jq.getScript("//cdn.drov.io/libs/codeMirror/codemirror.js", function() {
		// Load code mirror addons
		jq.getScript("//cdn.drov.io/libs/codeMirror/addons/edit/matchbrackets.js");
		jq.getScript("//cdn.drov.io/libs/codeMirror/addons/comment/continuecomment.js");
		jq.getScript("//cdn.drov.io/libs/codeMirror/addons/comment/comment.js");
		jq.getScript("//cdn.drov.io/libs/codeMirror/addons/search/search.js");
		jq.getScript("//cdn.drov.io/libs/codeMirror/addons/search/searchcursor.js");
		jq.getScript("//cdn.drov.io/libs/codeMirror/addons/dialog/dialog.js");
		
		// Load code mirror scripts
		jq.getScript("//cdn.drov.io/libs/codeMirror/modes/php/php.js");
		jq.getScript("//cdn.drov.io/libs/codeMirror/modes/htmlmixed/htmlmixed.js");
		jq.getScript("//cdn.drov.io/libs/codeMirror/modes/xml/xml.js");
		jq.getScript("//cdn.drov.io/libs/codeMirror/modes/javascript/javascript.js");
		jq.getScript("//cdn.drov.io/libs/codeMirror/modes/css/css.js");
		jq.getScript("//cdn.drov.io/libs/codeMirror/modes/sql/sql.js");
		jq.getScript("//cdn.drov.io/libs/codeMirror/modes/clike/clike.js");
