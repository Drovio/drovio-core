 ...
 * 
 * @version	0.1-3
 * @created	September 19, 2014, 14:37 (EEST)
...
class srcObject extends classObject
{
	 ...
	 * @return	void
	 */
	public function __construct($websiteID, $library, $package, $namespace = "", $objectName = NULL)
	{
		// Init application
	...
	public function create($name, $title)
	{
		...
		// Create vcs item
		$itemID = $this->getItemID();
		$itemPath = website::SOURCE_FOLDER."/".$this->getItemPath();
	...
	protected function getItemID()
	{
		...
		return $this->website->getItemID($suffix);
	}
	...
	{  
		$path = systemRoot.paths::getDevRsrcPath()."/websites/headers/sourceObject.inc";
	...
	/**
	 * Removes the object from the source.
	 * 
	 * @return	boolean
