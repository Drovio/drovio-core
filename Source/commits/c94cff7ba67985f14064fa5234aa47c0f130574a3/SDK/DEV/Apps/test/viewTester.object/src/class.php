 ...
 * @revised	August 25, 2014, 12:06 (EEST)
 */
class viewTester extends tester
{
	...
	public static function activate($appID, $views = "all")
	{
		...
		if (is_array($views))
		{
			...
			return parent::activate("appTester_v_id".$appID, $viewList);
		}
		else
			return parent::activate("appTester_v_id".$appID, "all");
	}
	...
	public static function deactivate($appID)
	{
		...
		// Deactivate packages
		return parent::deactivate("appTester_v_id".$appID);
	}
	...
	public static function status($appID, $view = "all")
	{
		...
		// Get status
		$status = parent::status("appTester_v_id".$appID);
	...
	{
		// Get Package List
		$list = parent::status("appTester_v_id".$appID);
