 ...
 * 
 * @version	0.1-2
 * @created	October 30, 2015, 18:42 (GMT)
 * @updated	October 30, 2015, 18:46 (GMT)
 */
class JShrink
{
	/**
	 ...
	 * 
	 * @return	mixed
	 * 		The minified code if success, false on failure.
	 */
	...
	/**
	 * Gets the next string for processing based off of the current index.
	 * 
	 * @return	string
	 * 		The next string for processing.
	 */
	 ...
	 * This has significant performance benefits as the skipping is done using native functions (ie, c code) rather than in script php.
	 * 
	 * @return	string
