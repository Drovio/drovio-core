...
class domain
{
	 ...
	 * 
	 * @param	string	$path
	 * 		The subdomain system folder path in the httpdocs folder.
	 * 
	 * @return	boolean
	...
	{
		// Set domain path
		$domain_path = (empty($path) ? strtolower($name) : strtolower($path));
		...
		$domainConfigFileContent = resource::get("/DEV/templates/domain.inc");
