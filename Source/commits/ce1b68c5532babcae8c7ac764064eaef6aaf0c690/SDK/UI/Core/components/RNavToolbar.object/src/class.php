 ...
 * @updated	June 16, 2015, 20:28 (EEST)
 */
class RNavToolbar extends UIObjectPrototype
{
	...
	private function buildDomainNavigation()
	{
		// Add global item
		$toolbarItem = new toolbarItem();
		$title = DOM::create("img");
		DOM::attr($title, "src", url::resolve("cdn", "/media/logos/logo.png"));
		$item = $toolbarItem->build($title, "", "drovio platform", toolbarItem::SCOPE_GLOBAL, $ico = TRUE)->get();
		...
		$this->ribbon->addCollection("platformNav", "Drov.IO", 366, "", TRUE);
