 ...
 * @revised	July 22, 2014, 18:58 (EEST)
 */
class phpParser extends codeParser
{
	 ...
	 * 		LOCPF: This is the lines of pure code devided by the number of functions. This approximates to the lines per function.
	 */
	public static function getMetrics($code){
		...
		$metrics['BLOC'] = $noCommentLines - $metrics['SLOC-P'];
		
		// Number of functions
		$metrics['NOF'] = preg_match_all("/\b[Ff]unction\b/", $code);
		
		// Average lines of code in functions*
		$metrics['LOCPF'] = $metrics['SLOC-P']/$metrics['NOF'];
