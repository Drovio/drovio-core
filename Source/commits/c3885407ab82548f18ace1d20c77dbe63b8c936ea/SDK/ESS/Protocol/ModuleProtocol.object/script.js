...
ModuleProtocol = {
	...
	trigger : function(ev, jqSender, method, callType, extraParams, successCallback, errorCallback, completeCallback, loading) {
		...
		if (jq.type(successCallback) == "undefined" || jq.type(successCallback) == "null") {
			...
			HTMLServerReport.request(requestUrl, jqSender, method, requestData, errorCallback, completeCallback, loading, callType);
		}
		else {
			// Start HTMLServerReport request
			JSONServerReport.request(requestUrl, jqSender, method, requestData, successCallback, errorCallback, completeCallback, loading, callType);
		}
	},
