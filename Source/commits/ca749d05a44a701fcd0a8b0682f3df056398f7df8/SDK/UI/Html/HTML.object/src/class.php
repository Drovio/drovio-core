 ...
 * @revised	February 15, 2014, 15:20 (EET)
 */
class HTML extends DOM
{
	 ...
	 * 
	 * @param	mixed	$context
	 * 		Can either be a DOMElement as the context of the search, or a css selector. If the selector results in multiple DOMNodes, then the first is selected as the context.
	 * 
	 * @return	mixed
	...
	public static function select($css, $context = NULL)
	{
		...
		// Identify Classes 
		//$xpath = preg_replace("/\.(-?[_a-zA-Z]+[_a-zA-Z0-9-]*)/", "[@class='$1'_xpsp_or_xpsp_contains(@class_xpcm_'_xpsp_$1_xpsp_')_xpsp_or_xpsp_starts-with(@class_xpcm_'$1_xpsp_')_xpsp_or_xpsp_ends-with(@class_xpcm_'_xpsp_$1')]", $xpath);
