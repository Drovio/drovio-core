...
$appID = $_REQUEST['__AID'];
$appID = (empty($appID) ? $_REQUEST['__APP__ID'] : $appID);
$appID = (empty($appID) ? $_REQUEST['__APP']['ID'] : $appID);
$appID = (empty($appID) ? $GLOBALS['__REQUEST']['ID'] : $appID);

$viewName = $_REQUEST['__AVN'];
$viewName = (empty($viewName) ? $_REQUEST['__APP__VIEW_NAME'] : $viewName);
...
appTester::setPublisherLock(TRUE, $subdomain);
