...
class appObject extends classObject2
{
	...
	public function __construct($library, $package, $namespace = "", $name = NULL)
	{
		...
		parent::__construct(paths::getDevPath()."/Repository/devKit/AppEngine/", FALSE, $library, $package, $namespace, $name);
	}
	...
	public function export()
	{
		...
		$sourceObjectPath = systemRoot."/System/Library/devKit/AppEngine/".$this->library."/".$this->package."/".str_replace("::", "/", $this->namespace)."/".$this->name.".php";
		...
		try
		{
			...
			$sourceDocObjectPath = systemRoot."/System/Resources/Documentation/devKit/AppEngine/".$this->library."/".$this->package."/".str_replace("::", "/", $this->namespace);
			...
			packageIndex::addObjectReleaseEntry("/System/Resources/Documentation/devKit/AppEngine/", $this->library, $this->package, $this->namespace, $this->name);
		...
		try
		{
			...
			$sourceModelObjectPath = systemRoot."/System/Resources/Model/devKit/AppEngine/".$this->libName."/".$this->packageName."/".str_replace("::", "/", $this->namespace);
			$context = $parser->getXML();
	...
	{
		// Package Path
		$indexFilePath = "/System/Library/devKit/AppEngine/".$this->library."/".$this->package."/";
