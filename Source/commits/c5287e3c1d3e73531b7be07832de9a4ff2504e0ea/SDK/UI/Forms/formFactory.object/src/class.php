 ...
 * @revised	September 4, 2014, 15:03 (EEST)
 */
class formFactory extends FormPrototype
{
	...
	{
		return FormProtocol::validate(self::getPostedFormID(), $_POST);
	}
	...
	public function engageModule($moduleID, $viewName = "")
	{
		...
		$input = $this->getInput($type = "hidden", $name = "__MODULE__ID", $value = $moduleID, $class = "", $autofocus = FALSE, $required = FALSE);
		$this->append($input);
		
		$input = $this->getInput($type = "hidden", $name = "__MODULE__VIEW_NAME", $value = $viewName, $class = "", $autofocus = FALSE, $required = FALSE);
		$this->append($input);
	...
	public function engageApp($appID, $viewName = "")
	{
		...
		// Add hidden for modules
		$input = $this->getInput($type = "hidden", $name = "__APP__ID", $value = $appID, $class = "", $autofocus = FALSE, $required = FALSE);
		$this->append($input);
		
		$input = $this->getInput($type = "hidden", $name = "__APP__VIEW_NAME", $value = $viewName, $class = "", $autofocus = FALSE, $required = FALSE);
		$this->append($input);
