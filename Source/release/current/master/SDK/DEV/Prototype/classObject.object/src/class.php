 ...
 * @updated	September 3, 2015, 13:18 (EEST)
 */
abstract class classObject
{
	 ...
	 * It will also check for syntax errors.
	 * 
	 * @param	string	$header
	 ...
	 * 		
	 * 		If there is a syntax error the file will be saved normally but it will return a string telling that there is a syntax error in the php file.
	 */
	...
	public function getNamespace($full = FALSE)
	{
		...
		// Replace characters to normalize it
