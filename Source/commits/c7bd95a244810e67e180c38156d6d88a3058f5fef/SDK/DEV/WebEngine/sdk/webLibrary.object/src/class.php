 ...
 * @updated	January 20, 2015, 15:43 (EET)
 */
class webLibrary
{
	/**
	...
	public static function publish($version, $branchName = vcs::MASTER_BRANCH)
	{
		...
		foreach ($libraries as $libName)
		{
			...
			foreach ($packages as $packageName)
			{
				...
				BootLoader2::exportCSS(webCoreProject::PROJECT_ID, $libName, $packageName, $cssContent, $version);
				...
				BootLoader2::exportJS(webCoreProject::PROJECT_ID, $libName, $packageName, $jsContent, $version);
			}
		}
	}
