...
class ModuleLoader
{
	...
	public static function getModuleResources($moduleID = "")
	{
		...
		// Get all modules to get resources for
	...
	private static function getModuleRsrcArray($moduleID)
	{
		...
		return BootLoader::getResourceArray(modulesProject::PROJECT_TYPE, "Modules", $moduleID, $cssResourceUrl, $jsResourceUrl, $tester);
	}
}
//#section_end#
?>