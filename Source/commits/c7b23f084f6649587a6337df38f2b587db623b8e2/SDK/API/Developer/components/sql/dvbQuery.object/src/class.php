 ...
 * @revised	April 1, 2014, 11:43 (EEST)
 * 
 * @deprecated	Use \DEV\Core\sql\sqlQuery instead.
 */
class dvbQuery
{
	/**
	...
	public function create($title, $description)
	{
		...
		// Add index entry
		$proceed = dvbDomain::addQuery($this->domain, "q.".$this->id, $title);
		if (!$proceed)
			return FALSE;
	...
	public function update($title, $query = "", $description = "", $transaction = TRUE, $accessLevel = 1, $attrs = array())
	{
		...
		// Update query in mapping
		dvbDomain::updateQuery("q.".$this->id, $this->title);
	...
	{/*
		...
		fileManager::create(systemRoot.$this->prdDirectory.$this->getName($this->id).".sql", $query, TRUE);
