 ...
 * @revised	September 9, 2014, 14:51 (EEST)
 */
class APPContent extends HTMLContent
{
	 ...
	 */
	public static function getAppContainer($appID, $viewName, $attr = array(), $startup = TRUE, $containerID = "")
	{
		$appContainer = new ApplicationContainerPrototype($appID, $viewName);
		return $appContainer->build($attr, $startup, $containerID)->get();
	}
