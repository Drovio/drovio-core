...
class ebObject extends classObject2
{
	...
	public function __construct($libName, $packageName, $nsName = "", $objectName = NULL)
	{
		...
		parent::__construct($repository, $includeRelease, $libName, $packageName, $nsName, $objectName);
	}
	...
	protected function createIndex()
	{
		...
		$libPath = paths::getDevRsrcPath()."/Mapping/Library/eBuilder/".$this->library.".xml";
	...
	{
		// Package Path
		$indexFilePath = "/System/Library/devKit/eBuilder/".$this->library."/".$this->package."/";
	...
	{
		// Export Source Code
		parent::export(systemRoot."/System/Library/devKit/eBuilder/");
		...
		try
		{
			...
			$sourceDocObjectPath = systemRoot."/System/Resources/Documentation/devKit/eBuilder/".$this->library."/".$this->package."/".str_replace("::", "/", $this->namespace);
			...
			packageIndex::addObjectReleaseEntry("/System/Resources/Documentation/devKit/eBuilder/", $this->library, $this->package, $this->namespace, $this->name);
		...
		try
		{
			...
			$sourceModelObjectPath = systemRoot."/System/Resources/Model/devKit/eBuilder/".$this->library."/".$this->package."/".str_replace("::", "/", $this->namespace);
			$context = $parser->getXML();
