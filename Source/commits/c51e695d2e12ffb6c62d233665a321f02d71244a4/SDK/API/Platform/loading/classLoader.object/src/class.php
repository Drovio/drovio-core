 ...
 * @revised	August 10, 2013, 12:28 (EEST)
 */
class classLoader
{
	/**
	 ...
	 * @type	string
	 */
	//private static $vcsPath = "/.developer/Repositories/Library/SDK/";
	private static $vcsPath = "/.developer/Repository/Core/trunk/master/SDK/";
	//private static $vcsPath = "/.developer/Repository/Library/SDK/trunk/master/";
	/**
	 * The inner trunk's path.
	 * 
	 * @type	string
	 */
	//private static $trunkPath = "/_vcs/trunk/master/";
	...
	{
		return self::packageStatus("sdk_".$libName."_".$packageName);
	}
	...
	{
		return (is_null(self::getCookie("tester")) ? FALSE : self::getCookie("tester"));
	}
