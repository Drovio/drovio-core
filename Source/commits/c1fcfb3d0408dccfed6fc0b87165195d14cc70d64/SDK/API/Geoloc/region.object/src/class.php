 ...
 * @revised	March 24, 2014, 9:57 (EET)
 */
class region
{
	/**
	 ...
	 * 		{description}
	 * 
	 * @deprecated	Use \API\Geoloc\locale::getInfo() instead.
	 */
	 ...
	 * 		{description}
	 * 
	 * @deprecated	Use \API\Geoloc\locale::getInfo() and get the country id from there instead.
	 */
	 ...
	 * 		{description}
	 * 
	 * @deprecated	Use \API\Geoloc\locale::getInfo() and get the country name from there instead.
	 */
