 ...
 * 
 * @version	4.0-1
 * @created	August 22, 2014, 11:40 (BST)
 * @updated	November 28, 2015, 18:59 (GMT)
 */
class appView
{
	/**
	...
	/**
	 * Gets whether this view has css code.
	 * 
	 * @return	boolean
	 * 		True or False.
	 */
	...
	{
		$css = $this->getCSS($normalCss = TRUE);
		return !empty($css);
	}
	...
	/**
	 * Gets whether this view has js code.
	 * 
	 * @return	boolean
	 * 		True or False.
	 */
