 ...
 * @revised	May 27, 2014, 10:25 (EEST)
 */
class sdkLibrary
{
	/**
	...
	/**
	 * Delete a library from the core SDK.
		...
		foreach ($libraries as $libName)
		{
			...
			foreach ($packages as $packageName)
			{
				...
				foreach ($objects as $objectInfo)
				{
					...
					$manFile = systemRoot."/System/Resources/Documentation/SDK/".$libName."/".$packageName."/".$ns."/".$objectInfo['name'].".php.man.xml";
