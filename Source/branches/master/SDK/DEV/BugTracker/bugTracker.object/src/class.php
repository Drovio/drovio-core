 ...
 * @updated	January 5, 2015, 11:20 (EET)
 * 
 * @deprecated	Use \BT\Projects\brProject and \BT\Issues\btIssue instead.
 */
class bugTracker
{
	/**
	 ...
	 * 		The developers' id that the bug is going to be assigned to.
	 * 
	 * @param	string	$filter
	...
	/**
	 * Deletes a bug from the Bugs database
	 * 
	 * @param	string	$id
	 * 		The bug id
	 * 
