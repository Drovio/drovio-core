 ...
 * @revised	March 31, 2014, 13:48 (EEST)
 */
abstract class classObject
{
	 ...
	 * 
	 * @return	string
	 * 		The item's unique id in the project.
	 */
	 ...
	 * 		Defines whether the path will include the object's name.
	 * 		FALSE by default.
	 * 
	 * @return	string
	 * 		The object's path.
	 */
	protected function getObjectPath($includeLibraryPath = TRUE, $includeObject = FALSE)
	{
		$library = ($includeLibraryPath ? $this->library : "");
		$namespace = str_replace("::", "/", $this->namespace);
		$objectName = ($includeObject ? $this->name.".".self::FILE_TYPE."/" : "");
		return "/".$library."/".$this->package."/".$namespace."/".$objectName;
	}
