 ...
 * @revised	February 12, 2014, 15:25 (EET)
 */
abstract class activityLogger
{
	...
	public function log($description)
	{
		...
		$filePath = paths::getSysDynDataPath().self::LOG_ROOT_FOLDER.$fileName;
	 ...
	 * 
	 * @return	array
	 * 		An array of logs with time and description as:
	 * 		['time'] = unix timestamp
	...
	public function getLogs()
	{
		...
		{
			$entry = array();
			$entry['time'] = $parser->attr($logentry, "time");
			$entry['description'] = $parser->nodeValue($logentry);
