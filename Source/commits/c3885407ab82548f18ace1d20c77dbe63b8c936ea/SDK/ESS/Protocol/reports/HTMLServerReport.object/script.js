...
HTMLServerReport = {
	request : function(serverUrl, jqSender, method, requestData, errorCallback, completeCallback, loading, callType) {
		...
		// Use new function
		JSONServerReport.request(serverUrl, jqSender, method, requestData, reportSuccessCallback, errorCallback, completeCallback, loading, callType);
	},
