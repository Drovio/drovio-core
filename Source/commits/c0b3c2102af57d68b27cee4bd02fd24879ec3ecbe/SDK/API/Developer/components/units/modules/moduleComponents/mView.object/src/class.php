 ...
 * @revised	December 6, 2013, 11:04 (EET)
 */
class mView
{
	/**
	...
	private function loadInfo()
	{
		...
		{
			$moduleID = $parser->attr($entry, "id");
			$friendlyName = $parser->nodeValue($entry);
			$this->innerModules[$moduleID] = $friendlyName;
		}
	}
	...
	public function run()
	{
		...
		// Run - Require
		return importer::req($itemPath."/view.php");
	}
	...
	private function buildHeader($wrapped = FALSE)
	{
		...
		// Get Headers
		$path = systemRoot.paths::getDevRsrcPath()."/Content/Modules/Headers/private2.inc";
