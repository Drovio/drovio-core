 ...
 * 
 * @version	2.0-1
 * @created	July 29, 2014, 20:40 (BST)
 * @updated	November 17, 2015, 17:57 (GMT)
 */
class JSONServerReport extends ServerReport
{
	...
	public static function get($allowOrigin = "", $withCredentials = TRUE)
	{
		...
		parent::setResponseHeaders(parent::CONTENT_APP_JSON);
		...
		parent::setAllowCredentials($withCredentials);
	 ...
	 * 
	 * @param	array	$headers
	 * 		The array where all the head will be appended to be returned to the caller, by head key name.
	 * 		It is a call by reference.
	 * 		It is empty array by default.
	 * 
	 * @return	void
	 */
	public static function parseReportContent($report, &$actions = array(), &$contents = array(), &$headers = array())
	{
