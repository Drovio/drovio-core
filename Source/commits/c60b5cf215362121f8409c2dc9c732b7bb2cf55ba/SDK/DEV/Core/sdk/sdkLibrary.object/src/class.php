...
class sdkLibrary
{
	...
	public static function publish($branchName = vcs::MASTER_BRANCH)
	{
		...
		fileManager::create(systemRoot.self::PUBLISH_PATH."map.xml", $contents, TRUE);
		...
		foreach ($libraries as $libName)
		{
			...
			foreach ($packages as $packageName)
			{
				...
				foreach ($objects as $objectInfo)
				{
					...
					// Copy source
					$sourceFile = systemRoot.self::PUBLISH_PATH.$libName."/".$packageName."/".$ns."/".$objectInfo['name'].".php";
