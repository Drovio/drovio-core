...
class application extends project
{
	...
	public function publish($version, $branchName = vcs::MASTER_BRANCH)
	{
		...
		foreach ($styles as $styleName)
		{
			...
			$appCssFileContent = BootLoader::resolveURLs($appID, $appCssFileContent, $version, $protocol = "https");
			...
			BootLoader::exportCSS($appID, $appID, $styleName, $appCssFileContent, $version);
		}
		...
		foreach ($scripts as $scriptName)
		{
			...
			BootLoader::exportJS($appID, $appID, $scriptName, $appJsFileContent, $version);
		}
