 ...
 * @revised	June 11, 2014, 10:35 (EEST)
 */
class ModuleProtocol
{
	 ...
	 * @return	void
	 */
	public static function addAction($item, $dataName, $moduleID, $auxName = "", $attr = array(), $loading = FALSE)
	{
		// Set action
		$actionArray = self::getAction($moduleID, $auxName, $loading);
	 ...
	 * @return	void
	 */
	public static function addAsync($item, $moduleID, $auxName = "", $holder = "", $startup = TRUE, $attr = array(), $loading = FALSE)
	{
		$actionArray = self::getAction($moduleID, $auxName, $holder, $loading);
	 ...
	 * @return	void
	 */
	public static function addActionGET($item, $moduleID, $auxName = "", $holder = "", $attr = array(), $loading = FALSE)
	{
		$actionArray = self::getAction($moduleID, $auxName, $holder, $loading);
	 ...
	 */
	public static function addActionPOST($item, $moduleID, $auxName = "", $holder = "", $attr = array(), $loading = FALSE)
	{
		$actionArray = self::getAction($moduleID, $auxName, $holder, $loading);
	 ...
	 * 		The data array.
	 */
	public static function getAction($id, $action = "", $holder = "", $loading = FALSE)
	{
		$actionArray = array();
		$actionArray['id'] = $id;
