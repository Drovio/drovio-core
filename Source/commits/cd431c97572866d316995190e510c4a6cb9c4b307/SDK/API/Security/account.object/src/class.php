 ...
 * @revised	December 31, 2013, 12:45 (EET)
 */
class account
{
	/**
	...
	public static function validate()
	{
		...
		if ((!isset($accountID) || !isset($mix)) && !self::$loggedIn)
		{
			self::logout();
			return FALSE;
		}
	...
	private static function getAccountValue($name)
	{
		...
		$exists = session::get("exists", "", "account");
		if ($exists)
