...
WHERE ({hid} IS NULL OR RTL_productInfoCategoryHierarchy.hierarchy_id = {hid}) AND (RTL_productInfoCategory.company_id IS NULL OR RTL_productInfoCategory.company_id = {cid});