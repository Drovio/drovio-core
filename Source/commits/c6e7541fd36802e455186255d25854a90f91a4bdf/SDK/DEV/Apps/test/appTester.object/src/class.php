...
class appTester extends tester
{
	 ...
	 * @type	string
	 */
	private static $domain = "developer";
	 ...
	 * 		The default value is for development environment and is 'developer'.
	 * 
	 * @return	void
	 */
	public static function setPublisherLock($status = TRUE, $domain = "developer")
	{
