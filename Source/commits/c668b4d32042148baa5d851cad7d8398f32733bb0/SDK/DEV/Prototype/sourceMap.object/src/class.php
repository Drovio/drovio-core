 ...
 * @updated	May 25, 2015, 16:53 (EEST)
 */
class sourceMap
{
	/**
	 ...
	 * @return	void
	 */
	public function __construct($folderPath, $mapFile = self::MAP_FILE, $rootRelative = FALSE)
	{
		$this->folderPath = ($rootRelative ? systemRoot : "").$folderPath;
