 ...
 * @updated	December 17, 2015, 17:52 (GMT)
 */
class engine
{
	/**
	...
	{
		// Return all the variables if name is empty
		if (empty($name))
			return self::getRequestData($jsonDecode = TRUE);
		
		// Get engine variable from http request
