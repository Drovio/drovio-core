...
class mQuery
{
	...
	public function getQuery($attr = array())
	{
		...
		$modulePath = mGroup::getTrail($moduleInfo['group_id']).module::getDirectoryName($moduleID);
		...
		if (file_exists(systemRoot.$queryFile))
		{
			...
			throw new Exception("Module Query '$queryName' not found.");
