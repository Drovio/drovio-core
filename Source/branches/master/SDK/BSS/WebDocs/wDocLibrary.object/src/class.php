 ...
 * 
 * @version	3.0-1
 * @created	September 5, 2014, 14:06 (BST)
 * @updated	November 21, 2015, 15:11 (GMT)
 */
class wDocLibrary
{
	/**
	 ...
	 * 		The team id to construct the doc library for.
	 * 		If empty it will get the current team.
	 * 		
	 * 		WARNING: If will be forced as empty when in secure mode.
	 * 
	 * @return	void
	 */
	...
	{
		// Set variables
		$this->teamID = (empty($teamID) || importer::secure() ? team::getTeamID() : $teamID);
		
		// Get Web Docs Service folder
		$this->serviceFolder = team::getServicesFolder($serviceName = "/WebDocs/", $teamID, $systemAppData = TRUE);
