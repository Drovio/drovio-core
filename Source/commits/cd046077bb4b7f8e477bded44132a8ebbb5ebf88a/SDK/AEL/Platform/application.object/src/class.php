 ...
 * @updated	June 9, 2015, 14:35 (EEST)
 */
class application
{
	/**
	...
	public static function onAPC()
	{
		...
		// Check if it is on Application Center
		return (empty($subdomain) || $subdomain == "www");
	}
	...
	/**
	 * Check whether the application is running on the Redback Enterprise.
	 * 
	 * @return	boolean
	 * 		True if the application is on BOSS, false otherwise.
	 */
	public static function onBOSS()
	{
		...
		// Check if it is on BOSS
		return (!empty($subdomain) && $subdomain != "www" && $subdomain != "developers");
	}
