...
class documentationViewer extends UIObjectPrototype
{
	...
	{		
		...
		$objectPath = "/".$libName."/".$packageName."/".$nsNorm;
		
		$this->classDocPath = "/System/Resources/Documentation/".$domain."/".$objectPath."/".$objectName.".php.xml";
		$this->objectManualPath = "/System/Resources/Documentation/".$domain."/".$objectPath."/".$objectName.".php.man.xml";
	 ...
	 * 		{description}
	 */
	public function build($level = "class", $hidePrivate = TRUE)
	{		
	...
	private function buildExtended()
	{
		...
		{
			if (!($this->hidePrivate && $scope == "private"))
			{
