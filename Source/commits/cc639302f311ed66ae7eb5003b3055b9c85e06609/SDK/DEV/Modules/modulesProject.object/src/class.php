 ...
 * 
 * @version	0.3-21
 * @created	December 18, 2014, 9:04 (GMT)
 * @updated	December 15, 2015, 19:24 (GMT)
 */
	...
	private function publishSource($version, $branchName = vcs::MASTER_BRANCH)
	{
		...
		foreach ($allModules as $row)
		{
			...
			foreach ($moduleViews as $viewID => $viewName)
			{
				...
				$contents_mini = $parser->getHTML();
				fileManager::create($modulePath."/v/".$viewID.".min.html", $contents_mini, TRUE);
