...
class sdkPackage
{
	...
	public function create($libName, $packageName)
	{
		...
		packageIndex::createReleaseIndex("/System/Library/SDK/", $libName, $packageName);
	...
	{	
		...
		packageIndex::createReleaseIndex("/System/Resources/Documentation/SDK/", $libName, $packageName);
		packageIndex::addLibraryEntry("/System/Resources/Documentation/SDK/", $libName, $packageName);
		
		// Create Model index and library entry
		//packageIndex::createReleaseIndex("/System/Resources/Model/SDK/", $libName, $packageName);
		//packageIndex::addLibraryEntry("/System/Resources/Model/SDK/", $libName, $packageName);
