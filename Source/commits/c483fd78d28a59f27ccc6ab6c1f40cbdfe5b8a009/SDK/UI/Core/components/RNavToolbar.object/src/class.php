...
class RNavToolbar extends UIObjectPrototype
{
	...
	private function buildDomainNavigation()
	{
		...
		DOM::attr($title, "src", url::resolve("cdn", "/media/dashboard/dashboard_x3.svg"));
		$item = $toolbarItem->build($title, "", "drovio platform", toolbarItem::SCOPE_GLOBAL, $ico = FALSE)->get();
