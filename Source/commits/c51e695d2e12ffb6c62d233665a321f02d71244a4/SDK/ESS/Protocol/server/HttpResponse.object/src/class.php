 ...
 * @revised	November 7, 2013, 11:16 (EET)
 */
class HttpResponse
{
	/**
	...
	/**
	 * Holds all the response status codes
	 * 
	 * @type	array
	 */
	...
	/**
	 * Returns the status code and the description of the given code
	 * 
	 * @param	int	$code
	 ...
	 * 
	 * @param	boolean	$allow
	 * 		The value of the header. FALSE by default.
	 * 
	 * @return	void
	 */
	 ...
	 * 
	 * @param	string	$type
	 * 		The content-type. It can accept all the constants given by this class.
	 * 
	 * @return	void
	 */
