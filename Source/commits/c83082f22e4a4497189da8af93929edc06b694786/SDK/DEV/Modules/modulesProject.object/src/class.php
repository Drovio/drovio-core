...
class modulesProject extends project
{
	...
	private function publishSource($version, $branchName = vcs::MASTER_BRANCH)
	{
		...
		while ($row = $dbc->fetch($result))
		{
			...
			$contents = BootLoader::resolveURLs(self::PROJECT_ID, $moduleCSS, $version, $protocol = NULL, $innerFolder);
			...
			$contents = BootLoader::resolveURLs(self::PROJECT_ID, $moduleJS, $version, $protocol = NULL, $innerFolder);
