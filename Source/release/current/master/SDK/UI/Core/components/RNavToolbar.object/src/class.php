 ...
 * @updated	December 19, 2015, 17:00 (GMT)
 */
class RNavToolbar extends UIObjectPrototype
{
	 ...
	 * 
	 * @param	boolean	$float
	 * 		Make toolbar float on the website instead of getting the toolbar height.
	 * 
	 * @return	RNavToolbar
	 * 		The RNabToolbar object.
	 */
	public function build($float = FALSE)
	{
		// Create toolbarContainer
		$toolbarHolder = DOM::create("div", "", "", "uiMainToolbar");
		$this->set($toolbarHolder);
		
		// Set toolbar as float
		if ($float)
			HTML::addClass($toolbarHolder, "ftlb");
