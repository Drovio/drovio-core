...
jq(document).one("ready.extra", function() {
	...
	jq(document).on("content.modified", function(){
		...
		gLists.find(".dataGridList .dataGridRow > .dataGridCheck :checked")
			.closest(".dataGridRow").addClass("selected").closest(".dataGridList").find(".dataGridHeader > .dataGridCheck [type='checkbox']").prop("checked", true);
	...
	// Check on click
	jq(document).on("click", ".dataGridList .dataGridRow", function(ev){
		if (ev.metaKey)
			jq(this).closest(".dataGridRow").find(".dataGridCheck input[type='checkbox']").trigger("click");
	});
	
	jq(document).on("click", ".dataGridList .dataGridHeader > .dataGridCheck [type='checkbox']", function(){
		var checked = jq(this).prop("checked"); 
		var glist = jq(this).closest(".dataGridList");
	...
	jq(document).on("change", ".dataGridList .dataGridRow > .dataGridCheck [type='checkbox']", function(ev){
		...
		jq(this).trigger("listUpdated.dataGridList", checkedLength);
	});
