 ...
 * @revised	September 18, 2013, 12:06 (EEST)
 */
...
{	
	 ...
	 * 		{description}
	 */
	public function build($title = "", $lang = "")
	{
	...
	private function setHead()
	{
		...
		$this->addMeta($name = "", $content = $locale, $httpEquiv = "Content-Language", $charset = "");
		
		// Robots Indexing
		$this->addMeta($name = "robots", $content = "FOLLOW, NOODP, NOYDIR", $httpEquiv = "", $charset = "");
		
		// Generator
		$this->addMeta($name = "generator", $content = "Redback eBuilder v1.0", $httpEquiv = "", $charset = "");
