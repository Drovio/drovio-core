 ...
 * @revised	June 28, 2014, 22:23 (EEST)
 */
class vcs
{
	/**
	...
	public function getItemTrunkPath($id)
	{
		...
		// Return item's trunk path
		return $this->repository.self::TRUNK_FOLDER.$workingBranch."/".$this->getItemPath($id, $workingBranch);
	}
	...
	public function getItemHeadPath($id)
	{
		...
		// Return item's trunk path
		return $this->repository.self::BRANCHES_FOLDER.$headBranch."/".$this->getItemPath($id, $workingBranch);
	}
