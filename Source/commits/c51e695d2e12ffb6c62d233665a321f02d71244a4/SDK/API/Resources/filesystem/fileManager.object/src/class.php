...
class fileManager
{
	 ...
	 * 		{description}
	 */
	public static function create($file, $contents = "", $recursive = FALSE)
	{
	...
	public static function remove($file)
	{
		...
		{
			logger::log("File '".$file."' doesn't exist to be removed.", logger::ERROR);
			$status = FALSE;
		}
	...
	public static function move($from_file, $to_file, $preventOverwrite = FALSE)
	{
		...
		if ($preventOverwrite && file_exists($to_file))
			...
			logger::log("File '".$from_file."' doesn't exist to be moved. Throwing Exception...", logger::ERROR);
	}
