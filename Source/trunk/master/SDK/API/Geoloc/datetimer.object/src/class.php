 ...
 * 
 * @version	2.0-2
 * @created	March 24, 2014, 8:03 (GMT)
 * @updated	October 19, 2015, 12:46 (BST)
 */
class datetimer
{
	/**
	...
	public static function live($time = "", $format = 'd F, Y \a\t H:i')
	{
		...
		DOM::data($timespan, "utime", $time);
		DOM::data($timespan, "format", $format);
