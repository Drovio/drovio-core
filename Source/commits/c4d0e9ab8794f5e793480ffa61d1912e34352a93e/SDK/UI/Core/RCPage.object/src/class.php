 ...
 * @updated	January 6, 2015, 18:36 (EET)
 */
		...
		foreach ($allLibraries as $library)
		{
			...
			foreach ($allPackages as $package)
			{
				...
				if (!empty($cssResourceUrl))
				{
					...
					BootLoader2::setResourceAttributes("css", $resource, "Packages", $rsrcID, !$testerStatus);
				}
				...
				if (!empty($jsResourceUrl))
				{
					...
					$rsrcID = BootLoader2::getRsrcID($library, $package);
					BootLoader2::setResourceAttributes("js", $resource, "Packages", $rsrcID, !$testerStatus);
				}
			}
		}
	}
